        ...
        switch(template){       // MANUAL CHANGE
            ...
            case 2:{
                ...
                */
                ...
                obstacles[4][0] = true; obstacles[4][1] = true; obstacles[4][4] = true; obstacles[4][5] = true; 
                ...
                obstacles[8][0] = true; obstacles[8][1] = true; obstacles[8][6] = true; 
                obstacles[9][0] = true; obstacles[9][1] = true; obstacles[9][2] = true; obstacles[9][3] = true; obstacles[9][6] = true; 
                break;
            }
            case 3:{
                /* Test TEMPLATE 3 */
                ...
                */
                ...
                obstacles[3][2] = true; obstacles[3][3] = true; obstacles[3][4] = true; obstacles[3][5] = true; obstacles[3][6] = true; 
                obstacles[4][0] = true; obstacles[4][1] = true; obstacles[4][2] = true; obstacles[4][3] = true; obstacles[4][5] = true; obstacles[4][6] = true; obstacles[4][7] = true; 
                obstacles[5][0] = true; obstacles[5][1] = true; obstacles[5][2] = true; obstacles[5][3] = true; obstacles[5][5] = true; obstacles[5][6] = true; obstacles[5][7] = true; 
